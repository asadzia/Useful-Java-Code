/**
 * The class for parsing the web Log file.
 * @author Asad zia
 * @Version 1.0 
 */
...
{
	/* setting up the date format variable */
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MMM/yyyy:kk:mm:ss Z", Locale.US);
    
    /**
     * a method for controlling how the string builder will function 
     * in the parsing of the web log string entry.
     * @param sb
     * @param delim
     * @return
     */
    public static String munchTo(StringBuilder sb, String delim) {
    ...
    /**
     * The main method for parsing the log file entries.
     * @param line
     * @return
     */
    ...
    /**
     * The helper method for parsing the date.
     * @param dateStr
     * @return
     */
